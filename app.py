...
def chatbot():
    ...
    if user_message:
        prompt = f"""
           Generate a list of user stories using the given template. Each user story should be labelled sequentially as "User Story 1", "User Story 2", and so on. Each story should include a description, pre-conditions, post-conditions, and acceptance criteria enclosed within curly braces.
        {user_message}
